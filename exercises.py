...
def manage_students():
  names = ["peri", "tia", "randall"]

  first_name = names[1]
  last_student = names[2]
  return first_name,last_student
...
def combine_foods():
  foods = ("apples", "bananas", "strawberries")
  meal = ""
...
#
# Using the slice operator, assign a new tuple containing only the last 
# two food strings in the foods to a variable named last_two_foods.
...
# named home_town_message a string with this format: “I was born in <city>, <state> - population of <population>”
...
#
# Assign to a variable named foods_with_an_a the 
# result of list comprehension that filters the foods tuple 
# to only include food strings that contain the letter 'a'.

# For example, if foods is a tuple of ('Taco', 'Burrito', 'Sandwich'),
# foods_with_an_a would be a list equal to ['Taco', 'Sandwich']

def filter_foods_with_a():
  foods = ("apples", "bananas", "strawberries", "lychee")
